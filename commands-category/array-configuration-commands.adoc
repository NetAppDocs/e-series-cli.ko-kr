...
link:../commands-a-z/set-storagearray-host-io-protocol.html["스토리지 어레이 호스트 I/O 프로토콜을 설정합니다"]
...
link:../commands-a-z/show-storage-array-host-io-protocol.html["스토리지 어레이 호스트 I/O 프로토콜 표시"]

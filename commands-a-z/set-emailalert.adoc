...
이 명령은 E4000, E2800, E5700, EF600, EF300, EF50 및 EF80 스토리지 어레이에 적용됩니다. 단, E2700 또는 E5600 어레이의 경우 스크립트 명령이 아닌 SMcli 명령으로 사용할 수 있습니다. 이 경우 명령은 관리 도메인 내의 모든 어레이에 적용됩니다.

...
---
= 볼륨 그룹 전체 프로비저닝 시작 - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
이 명령은 모든 SMcli 패키지가 설치되어 있는 한 EF600, EF300, EF50 및 EF80 어레이를 포함한 모든 개별 스토리지 어레이에 적용됩니다.



== 역할

EF600, EF300, EF50 및 EF80 스토리지 어레이에서 이 명령을 실행하려면 Storage Admin 역할이 있어야 합니다.

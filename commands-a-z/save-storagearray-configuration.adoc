...
E4000, E2800, E5700, EF600, EF300, EF50 또는 EF80 스토리지 어레이에서 이 명령을 실행하려면 Storage Admin 역할이 있어야 합니다. 그러나 LDAP 매개 변수와 함께 이 명령을 사용하는 것은 Security Admin 역할을 가진 사용자로 제한됩니다.
